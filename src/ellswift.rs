...
use crate::{constants, from_hex, Context, Error, PublicKey, Secp256k1, SecretKey};
...
impl ElligatorSwift {
    ...
    pub fn as_array(&self) -> [u8; 64] { self.0.into_array() }
    ...
    pub fn shared_secret(
        ...
        unsafe {
            secp256k1_ellswift_xdh(
                ...
                data.map(|d| d.as_ptr()).unwrap_or(core::ptr::null()) as *mut c_void,
            );
        }
